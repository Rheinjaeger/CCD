...
*   Description  : This function is called once every 1 ms by the Systick interrupt.
*                  See the timer interrupt service routine in bsp_timer.c.
*                  Some periodic tasks can be placed here, for example: touch coordinate scanning.
*   Parameter    : None
*   Return Value : None
*********************************************************************************************************
*/
...
*   Description  : This function is called once every 10 ms by the Systick interrupt.
*                  See the timer interrupt service routine in bsp_timer.c.
*                  Tasks with less strict timing requirements can be placed here,
*                  for example: key scanning, buzzer control, etc.
*   Parameter    : None
*   Return Value : None
*********************************************************************************************************
*/
